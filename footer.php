<footer>
    <div class="footer">
        ...
        <div class="footer-container">
            ...
            <a href="#" class="footer-container__body"><img src="images/appstore.png" alt="AppStore"></a>
        </div>
    </div>
    ...
    <div class="copyright">
        ...
        <div class="copyright__body">&copy;  <?php echo date("Y"); echo " "; echo bloginfo('name'); ?><span>,created by Rajdeep</span></div>
    </div>
</footer>
